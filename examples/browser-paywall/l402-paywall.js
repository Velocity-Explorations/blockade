...
(function () {
  ...
  function injectStyles() {
    ...
    css.textContent = [
      ...
      '  color: #F5F5F5; font-size: 14px; line-height: 1.5;',
      '}',
      '.l402-modal {',
      ...
      '}',
      ".l402-hdr h2 { font-family: 'Inter Tight', 'Helvetica Neue', Arial, sans-serif; font-size: 16px; font-weight: 600; margin: 0; letter-spacing: -0.015em; }",
      '.l402-close {',
      '  background: none; border: none; color: #757575; font-size: 22px;',
      '  cursor: pointer; padding: 0 4px; line-height: 1;',
      '}',
      '.l402-close:hover { color: #F5F5F5; }',
      '.l402-body { padding: 20px; }',
      '.l402-meta { margin-bottom: 16px; }',
      '.l402-meta-row {',
      '  display: flex; justify-content: space-between; align-items: baseline;',
      '  font-size: 13px; color: #BEBEBE; margin-bottom: 4px;',
      '}',
      '.l402-meta-val { color: #F5F5F5; font-weight: 500; }',
      ".l402-price { color: #FFCB03 !important; font-family: 'Chakra Petch', ui-monospace, SFMono-Regular, Menlo, monospace !important; font-size: 18px !important; font-weight: 700 !important; }",
      '.l402-enroll-badge {',
      '  display: inline-block; background: rgba(255,203,3,.15); color: #FFCB03;',
      '  font-size: 11px; font-weight: 700; padding: 2px 8px; border-radius: 4px;',
      '  letter-spacing: .04em; text-transform: uppercase; margin-bottom: 12px;',
      '}',
      '.l402-enroll-note {',
      '  font-size: 13px; color: #FFCB03; margin-bottom: 16px;',
      '  padding: 10px 12px; background: rgba(255,203,3,.08);',
      '  border: 1px solid rgba(255,203,3,.2); border-radius: 6px;',
      '}',
      ...
      '}',
      '.l402-invoice-text {',
      "  flex: 1; background: #141414; border: 1px solid #2A2A2A; border-radius: 4px;",
      "  padding: 8px 10px; font-family: 'Chakra Petch', ui-monospace, SFMono-Regular, Menlo, monospace; font-size: 11px;",
      '  color: #FFCB03; word-break: break-all; max-height: 72px; overflow-y: auto;',
      '  user-select: all;',
      '}',
      '.l402-copy {',
      '  background: #2A2A2A; border: none; color: #757575; border-radius: 4px;',
      '  padding: 8px 12px; cursor: pointer; font-size: 12px; white-space: nowrap;',
      '}',
      '.l402-copy:hover { color: #F5F5F5; }',
      '.l402-btn {',
      ...
      '}',
      '.l402-btn-pay { background: #FFCB03; color: #1E1E1E; }',
      '.l402-btn-pay:hover { background: #E5B703; }',
      '.l402-btn-pay:disabled { background: #2A2A2A; color: #757575; cursor: not-allowed; }',
      '.l402-divider {',
      '  display: flex; align-items: center; gap: 10px; margin: 16px 0;',
      '  font-size: 12px; color: #BEBEBE;',
      '}',
      '.l402-divider::before, .l402-divider::after {',
      '  content: ""; flex: 1; height: 1px; background: #2a2a2a;',
      '}',
      '.l402-fallback-input {',
      "  width: 100%; background: #141414; border: 1px solid #2A2A2A; border-radius: 4px;",
      "  padding: 10px 12px; font-family: 'Chakra Petch', ui-monospace, SFMono-Regular, Menlo, monospace; font-size: 12px;",
      '  color: #F5F5F5; outline: none; margin-top: 8px; box-sizing: border-box;',
      '}',
      '.l402-fallback-input:focus { border-color: #FFCB03; }',
      '.l402-btn-submit { background: #2A2A2A; color: #F5F5F5; }',
      '.l402-btn-submit:hover { background: #333; }',
      '.l402-expiry { text-align: center; font-size: 12px; color: #BEBEBE; margin-top: 12px; }',
      '.l402-status {',
      ...
      '  border: 3px solid #2A2A2A; border-top-color: #FFCB03;',
      '  border-radius: 50%; animation: l402spin .7s linear infinite;',
      '}',
      '@keyframes l402spin { to { transform: rotate(360deg); } }',
      '.l402-err { color: #E5484D; font-size: 13px; }',
      '.l402-granted-text { color: #56C596; font-weight: 600; font-size: 16px; }',
